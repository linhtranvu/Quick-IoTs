...
(function (t) {
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        serialize: function (e) {
            var i = this._getItemsAs$(e && e.connected),
                s = [];
...
(function (t, e) {
    ...
    t.widget("ui.tabs", {
        ...
        _eventHandler: function (e) {
            ...
            e.preventDefault(), a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || this._trigger("beforeActivate", e, u) === !1 || (i.active = r ? !1 : this.tabs.index(a), this.active = o ? t() : a, this.xhr && this.xhr.abort(), l.length || h.length || t.error("$ UI Tabs: Mismatching fragment identifier."), h.length && this.load(this.tabs.index(a), e), this._toggle(e, u))
        },
