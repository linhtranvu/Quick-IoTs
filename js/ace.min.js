...
function handle_side_menu() {
    ...
    var cookie = $.cookie('cookie_menu-min');

    if(typeof cookie == "undefined"){
    	$.cookie('cookie_menu-min', b, { expires: 365 });
    }else{
        if(cookie === "true"){
        	b = true;
        }else{
    ...
    if (b===true) {    	
        ...
        $("#sidebar-collapse").find('[class*="icon-"]:eq(0)').addClass("icon-double-angle-right");
        $(".open > .submenu").removeClass("open");
    	//$("#sidebar-collapse").trigger(ace.click_event);
        $('#sidebar #module-left').hide();
        
    	
    }else{    	
        $("#sidebar").removeClass("menu-min");
        $("#sidebar-collapse").find('[class*="icon-"]:eq(0)').removeClass("icon-double-angle-right");
        $(".open > .submenu").addClass("open");
        $('#sidebar #module-left').show();
